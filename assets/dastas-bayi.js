jQuery(document).ready(function($) {
    // Ensure AJAX globals exist to prevent ReferenceError if localization missing
    window.dastas_ajax = window.dastas_ajax || { ajax_url: window.ajaxurl || '/wp-admin/admin-ajax.php', nonce: '' };
    window.ajaxurl = window.ajaxurl || window.dastas_ajax.ajax_url || '/wp-admin/admin-ajax.php';
    window.nonce = window.nonce || window.dastas_ajax.nonce || '';
...
})(jQuery);    // Şifremi Unuttum linkine tıklama
